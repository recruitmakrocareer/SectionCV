...
const publicFiles = [
  ...
  'order-game/art/products-photo.png', 'order-game/index.html', 'order-game/game.js', 'order-game/style.css', 'order-game/art/apple.svg', 'order-game/art/milk.svg', 'order-game/art/carrot.svg', 'order-game/art/fish.svg', 'order-game/art/cheese.svg', 'order-game/art/bread.svg', 'order-game/art/cart.svg', 'order-game/art/gift.svg', 'lobby.js', 'memory-game/game.js', 'memory-game/index.html', 'docs/memory-game/index.html',
